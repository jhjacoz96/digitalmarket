                    ...
                    <div class="carousel-inner">
                        @foreach ($banner as $key=> $item)
                            ...
                            <div class="item @if($key==0) active @endif">
                                <a href="{{$item->imagen->link}}" title="{{$item->titulo}}"><img src="{{$item->imagen->url}}" alt=""></a>
                            ...
                            <div class="single-products">
                                   ...
                                   <div class="product-overlay">
                                        <div class="overlay-content">
                                            <h2>Bs {{$productos->precioActual}}</h2>
                                            <p>{{$productos->nombre}}</p>
                                            <a href="{{url('/detalleProducto/'.$productos->slug)}}" class="btn btn-default add-to-cart">S<i class="fa fa-shopping-cart"></i>Agregar a carrito</a>
                                        </div>
                                    </div>
                            </div>
                            <div class="choose">
