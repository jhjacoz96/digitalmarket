  ...
  <section class="content-header">
    ...
    <h1>Tienda</h1>
        ...
        <div class="col-sm-6">
          ...
          <li class="breadcrumb-item"><a href="{{route('tienda.edit',$tienda)}}">Actualizar</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
            <form role="form" action="{{route('tienda.updatePassword',$tienda)}}" method="post" id="quickForm">
