...
class CreateMedioEnviosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('medio_envios', function (Blueprint $table) {
            ...
            $table->decimal('0kgA30kg',12,2)->default(0);
            $table->decimal('31kgA50kg',12,2)->default(0);
            $table->decimal('50kgA100kg',12,2)->default(0);
            $table->decimal('101kgA200kg',12,2)->default(0);
            $table->decimal('mayorA201kg',12,2)->default(0);
            $table->decimal('envioGratisApartir',12,2)->nullable();
