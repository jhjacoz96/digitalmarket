                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-danger">
                      ...
                      <a href="{{route('pedido.consultar','cancelado')}}" class="small-box-footer">Ver detalles<i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                  <div class="col-lg-3 col-6">
                    <!-- small box -->
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="card card-info">
                        <div class="card-header">
                          <h3 class="card-title">Medios de pagos mas usados</h3>
                          <div class="card-tools">
                            <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i>
                            </button>
                            <button type="button" class="btn btn-tool" data-card-widget="remove"><i class="fas fa-times"></i></button>
                        ...
                        <div class="card-body">
                          <div class="position-relative mb-4">
                            <div style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%;"  id="div_grafica_colum_pago"></div>
                          </div>
                        </div>
