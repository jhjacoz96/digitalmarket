                ...
                <div class="card-body">
                  @if(\Auth::user()->rol_id=='3')
                    <div class="form-group">
                      ...
                      <input type="text"  name="nombre" value="{{$user->nombre}}" class="form-control" id="nombre" placeholder="Ingrese su nombre" >
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text"  name="correo" class="form-control" value="{{$user->email}}"id="correo" placeholder="Ingrese un correo electrónico" >
