function cambiar_fecha_grafica(){
    ...
    cargar_grafica_barra_pago(anio_sel,mes_sel);
...
function cargar_grafica_barra_pago(anio,mes){
   
 var options= {
      chart: {
          renderTo:'div_grafica_colum_pago',
          type: 'column',
          scrollablePlotArea: {
              minWidth: 700,
              scrollPositionX: 1
      ...
      title: {
          text: 'Pedidos por medio de pago'
      },
      xAxis: {
          categories: [],
          crosshair: true
      ...
      yAxis: {
          ...
          crosshair: true,
          title: {
              text: 'Cantidad de medios de pago'
          }
      },
      tooltip: {
          headerFormat: '<span style="font-size:10px">{point.key}</span><table>',
