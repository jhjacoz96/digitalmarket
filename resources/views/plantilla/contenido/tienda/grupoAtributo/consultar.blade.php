            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body table-responsive p-0">
                    ...
                    <tbody>
                       ...
                       <td class="mailbox-star">{{$item->id}}</td>
                           ...
                           <td class="mailbox-star">
                               ...
                               <a href="{{route('tiendas.grupoAtributo.edit',$item)}}" class="btn btn-default btn-sm">  <span class="fas fa-edit" aria-hidden ="true" ></span></a>

                                   
                                   
                                   <form action="{{route('tiendas.grupoAtributo.destroy',$item)}}" method="POST">
                                       @method('DELETE')
                                       @csrf
                  ...
                  <a href=" {{route('tiendas.grupoAtributo.create')}} "  class="btn  btn-info ">Agregar grupo atributo</a>
