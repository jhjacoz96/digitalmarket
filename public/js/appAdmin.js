  ...
  methods: {
    ...
    eliminarImagen: function eliminarImagen(imagen) {
      Swal.fire({
        ...
        if (result.value) {
          //eliminar la imagen
          var url = '/eliminarImagen/' + imagen.id;
          axios["delete"](url).then(function (res) {
            console.log(res.data);
          });
          var elemento = document.getElementById('idimagen-' + imagen.id);
          elemento.parentNode.removeChild(elemento);
          Swal.fire('Eliminado!', 'Su archivo se ha elimianda', 'success');
        }
      });
    },
...
/***/ "./resources/js/admin/searchAutoComplete.js":
/*!**************************************************!*\
  !*** ./resources/js/admin/searchAutoComplete.js ***!
  \**************************************************/
/*! no exports provided */
...
var searchAutoComplete = new Vue({
    ...
    autoComplete: function autoComplete() {
      ...
      if (this.palabraBuscar.length > 2) {
        axios.get('/autoComplete/', {
          params: {
            palabraBuscar: this.palabraBuscar
          }
        }).then(function (res) {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this2.palabraBuscar = resultado.nombre;
                _context.next = 3;
...
/***/ 1:
/*!****************************************!*\
  !*** multi ./resources/js/appAdmin.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\Programas\laragon\www\digitalmarket\resources\js\appAdmin.js */"./resources/js/appAdmin.js");
