        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
            <form role="form" action="{{route('banner.store')}}" method="post"  enctype="multipart/form-data" id="quickForm">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group col-md-6">
                      <label for="exampleInputEmail1">Link</label>
                        ...
                        <input type="text" required="true" name="link" class="form-control" >
                    ...
                    <div class="form-group col-md-6">
                      <label for="exampleInputEmail1">Titulo</label>
                        ...
                        <input type="text" required="true" name="titulo" class="form-control" >
                    ...
                    <div class="form-group">
                        ...
                        <label for="imagen">Subir imagen del banner</label> 
                ...
                <a href="" class="btn btn-secondary float-left">Atrás</a>
                  <button type="submit" class="btn btn-primary float-right">Agregar banner</button>
                </div>
